...
SELECT NAME, MAJOR, ENR_DATE FROM STUDENT 
    WHERE MAJOR = '국문학과';
    // WHERE NAME = '김유신'; 결과 값은 같지만 문제가 국문학과 학생 조회였음
...
SELECT STDNO, NAME, BIRTH FROM STUDENT 
    WHERE BIRTH >= '1992-01-01' ORDER BY BIRTH ASC;
    // BIRTH ORDER ASC 넣었음
